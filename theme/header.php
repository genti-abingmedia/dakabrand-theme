            ...
            <div class="site-branding">
                ...
                <?php else : ?>
                    <a class="site-brand" href="<?php echo esc_url(home_url('/')); ?>" rel="home">
                        <img src="<?php echo esc_url(staticbridge_resize_image_url(get_template_directory_uri() . '/assets/images/dakabrand-logo.png', 86, 42)); ?>" width="86" height="42" alt="<?php echo esc_attr(get_bloginfo('name')); ?>">
                    </a>
                <?php endif; ?>
            </div>
            ...
            <nav class="fashion-navigation d-none d-lg-block" aria-label="<?php esc_attr_e('Shop by department', 'dakabrand'); ?>" data-fashion-navigation>
                ...
                <div class="fashion-navigation__collections<?php echo 'women' === $active_fashion_department ? ' is-current' : ''; ?>" data-fashion-collection="women"<?php echo 'women' !== $active_fashion_department ? ' hidden' : ''; ?>>
                    ...
                    <div class="fashion-mega-menu" data-mega-panel="women-new-in" aria-label="<?php esc_attr_e('Women new arrivals', 'dakabrand'); ?>">
                        ...
                        <a class="fashion-mega-menu__feature" href="<?php echo esc_url(home_url('/product-category/women/new-collection-women/')); ?>"><img src="<?php echo esc_url(staticbridge_resize_image_url(get_template_directory_uri() . '/assets/images/woman-editorial-primary.jpg', 620, 596)); ?>" alt="<?php esc_attr_e('New women’s arrivals', 'dakabrand'); ?>"><span><?php esc_html_e('View all', 'dakabrand'); ?></span></a>
                    </div>
                    ...
                    <div class="fashion-mega-menu" data-mega-panel="women-shoes" aria-label="<?php esc_attr_e('Women shoe categories', 'dakabrand'); ?>">
                        ...
                        <a class="fashion-mega-menu__feature" href="<?php echo esc_url(staticbridge_catalog_category_url('/product-category/women/', 'shoes')); ?>"><img src="<?php echo esc_url(staticbridge_resize_image_url(get_template_directory_uri() . '/assets/images/mega-women-shoes.jpg', 300, 300)); ?>" alt="<?php esc_attr_e('Women’s shoes', 'dakabrand'); ?>"><span><?php esc_html_e('View all', 'dakabrand'); ?></span></a>
                    </div>
                    <div class="fashion-mega-menu" data-mega-panel="women-accessories" aria-label="<?php esc_attr_e('Women accessory categories', 'dakabrand'); ?>">
                        ...
                        <a class="fashion-mega-menu__feature" href="<?php echo esc_url(staticbridge_catalog_category_url('/product-category/women/', 'accessories')); ?>"><img src="<?php echo esc_url(staticbridge_resize_image_url(get_template_directory_uri() . '/assets/images/woman-product-chanel-380.jpg', 300, 300)); ?>" alt="<?php esc_attr_e('Women’s accessories', 'dakabrand'); ?>"><span><?php esc_html_e('View all', 'dakabrand'); ?></span></a>
                    </div>
                    <div class="fashion-mega-menu" data-mega-panel="women-preorder" aria-label="<?php esc_attr_e('Women preorder categories', 'dakabrand'); ?>">
                        <div class="fashion-mega-menu__groups"><div><strong><?php esc_html_e('Shop by category', 'dakabrand'); ?></strong><a href="<?php echo esc_url(staticbridge_preorder_category_url('/product-category/women/', 'clothing')); ?>">Clothing</a><a href="<?php echo esc_url(staticbridge_preorder_category_url('/product-category/women/', 'shoes')); ?>">Shoes</a><a href="<?php echo esc_url(staticbridge_preorder_category_url('/product-category/women/', 'handbags')); ?>">Bags</a><a href="<?php echo esc_url(staticbridge_preorder_category_url('/product-category/women/', 'belts-women')); ?>">Belts</a></div></div>
                        <a class="fashion-mega-menu__feature" href="<?php echo esc_url(home_url('/shop/?stock_status=onbackorder%3Aonbackorder')); ?>"><img src="<?php echo esc_url(staticbridge_resize_image_url(get_template_directory_uri() . '/assets/images/woman-editorial-secondary.jpg', 620, 596)); ?>" alt="<?php esc_attr_e('Women’s preorder collection', 'dakabrand'); ?>"><span><?php esc_html_e('View all', 'dakabrand'); ?></span></a>
                    </div>
                </div>
                ...
                <div class="fashion-navigation__collections<?php echo 'men' === $active_fashion_department ? ' is-current' : ''; ?>" data-fashion-collection="men"<?php echo 'men' !== $active_fashion_department ? ' hidden' : ''; ?>>
                    ...
                    <div class="fashion-mega-menu" data-mega-panel="men-new-in" aria-label="<?php esc_attr_e('Men new arrivals', 'dakabrand'); ?>">
                        ...
                        <a class="fashion-mega-menu__feature" href="<?php echo esc_url(home_url('/product-category/man/new-collection-man/')); ?>"><img src="<?php echo esc_url(staticbridge_resize_image_url(get_template_directory_uri() . '/assets/images/man-editorial-primary.jpg', 620, 596)); ?>" alt="<?php esc_attr_e('New men’s arrivals', 'dakabrand'); ?>"><span><?php esc_html_e('View all', 'dakabrand'); ?></span></a>
                    </div>
                    <div class="fashion-mega-menu" data-mega-panel="men-clothing" aria-label="<?php esc_attr_e('Men clothing categories', 'dakabrand'); ?>">
                        ...
                        <a class="fashion-mega-menu__feature" href="<?php echo esc_url(staticbridge_catalog_category_url('/product-category/man/', 'clothing-man')); ?>"><img src="<?php echo esc_url(staticbridge_resize_image_url(get_template_directory_uri() . '/assets/images/mega-men-clothing.jpg', 300, 300)); ?>" alt="<?php esc_attr_e('Men’s clothing', 'dakabrand'); ?>"><span><?php esc_html_e('View all', 'dakabrand'); ?></span></a>
                    </div>
                    <div class="fashion-mega-menu" data-mega-panel="men-shoes" aria-label="<?php esc_attr_e('Men shoe categories', 'dakabrand'); ?>">
                        ...
                        <a class="fashion-mega-menu__feature" href="<?php echo esc_url(staticbridge_catalog_category_url('/product-category/man/', 'shoes-man')); ?>"><img src="<?php echo esc_url(staticbridge_resize_image_url(get_template_directory_uri() . '/assets/images/mega-men-shoes.jpg', 300, 300)); ?>" alt="<?php esc_attr_e('Men’s shoes', 'dakabrand'); ?>"><span><?php esc_html_e('View all', 'dakabrand'); ?></span></a>
                    </div>
                    <div class="fashion-mega-menu" data-mega-panel="men-accessories" aria-label="<?php esc_attr_e('Men accessory categories', 'dakabrand'); ?>">
                        ...
                        <a class="fashion-mega-menu__feature" href="<?php echo esc_url(staticbridge_catalog_category_url('/product-category/man/', 'accessories-man')); ?>"><img src="<?php echo esc_url(staticbridge_resize_image_url(get_template_directory_uri() . '/assets/images/man-product-hermes-190.jpg', 300, 300)); ?>" alt="<?php esc_attr_e('Men’s accessories', 'dakabrand'); ?>"><span><?php esc_html_e('View all', 'dakabrand'); ?></span></a>
                    </div>
                    <div class="fashion-mega-menu" data-mega-panel="men-preorder" aria-label="<?php esc_attr_e('Men preorder categories', 'dakabrand'); ?>">
                        <div class="fashion-mega-menu__groups"><div><strong><?php esc_html_e('Shop by category', 'dakabrand'); ?></strong><a href="<?php echo esc_url(staticbridge_preorder_category_url('/product-category/man/', 'clothing-man')); ?>">Clothing</a><a href="<?php echo esc_url(staticbridge_preorder_category_url('/product-category/man/', 'shoes-man')); ?>">Shoes</a><a href="<?php echo esc_url(staticbridge_preorder_category_url('/product-category/man/', 'accessories-man')); ?>">Accessories</a><a href="<?php echo esc_url(staticbridge_preorder_category_url('/product-category/man/', 'bags')); ?>">Bags</a></div></div>
                        <a class="fashion-mega-menu__feature" href="<?php echo esc_url(home_url('/shop/?stock_status=onbackorder%3Aonbackorder')); ?>"><img src="<?php echo esc_url(staticbridge_resize_image_url(get_template_directory_uri() . '/assets/images/man-editorial-secondary.jpg', 620, 596)); ?>" alt="<?php esc_attr_e('Men’s preorder collection', 'dakabrand'); ?>"><span><?php esc_html_e('View all', 'dakabrand'); ?></span></a>
                    </div>
                </div>
            </nav>
