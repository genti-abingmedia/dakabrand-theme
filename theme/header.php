        ...
        <div class="site-shell site-header__inner">
            ...
            <nav class="fashion-navigation d-none d-lg-block" aria-label="<?php esc_attr_e('Shop by department', 'dakabrand'); ?>" data-fashion-navigation>
                <div class="fashion-navigation__departments" role="tablist" aria-label="<?php esc_attr_e('Departments', 'dakabrand'); ?>">
                    ...
                    <a class="fashion-navigation__department<?php echo 'men' === $active_fashion_department ? ' is-current' : ''; ?>" href="<?php echo esc_url(home_url('/man/')); ?>" role="tab" aria-selected="<?php echo 'men' === $active_fashion_department ? 'true' : 'false'; ?>" data-fashion-department="men"><?php esc_html_e('Man', 'dakabrand'); ?></a>
                </div>
